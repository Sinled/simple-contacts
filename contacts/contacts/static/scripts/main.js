...
(function() {
  window.App = {
    ...
    template: function(templateName) {
      return _.template($("[data-template=" + templateName + "]").html());
    },
...
(function() {
  ...
  App.Models.ContactModel = (function(_super) {
    ...
    ContactModel.prototype.validate = function(attrs) {
      if (!$.trim(attrs.first_name)) {
        'A contact requires a valid Name';
      }
      if (!$.trim(attrs.last_name)) {
        'A contact requires a valid Last name';
      }
      if (!$.trim(attrs.position)) {
        'A contact requires a valid position';
      }
      if (!$.trim(attrs.phone)) {
        return 'A contact requires a valid phone';
      }
    };
...
//@ sourceMappingURL=addContact.map
(function() {
  'use strict';
  var _ref,
    __hasProp = {}.hasOwnProperty,
  ...
  App.Views.AddContactView = (function(_super) {
    __extends(AddContactView, _super);

    function AddContactView() {
      _ref = AddContactView.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    AddContactView.prototype.template = App.template('editContact');

    AddContactView.prototype.initialize = function() {
      if (DEBUG) {
        return console.log("init AddContactView", this.model);
      }
    };

    AddContactView.prototype.events = {
      'submit': 'addContact',
    ...
    AddContactView.prototype.addContact = function(event) {
      var form;
      ...
      App.vent.trigger('addContact:contact', this.model);
      return this.unrender();
    };

    AddContactView.prototype.closeEdit = function(event) {
      event.preventDefault();
      return this.unrender();
    };

    AddContactView.prototype.unrender = function() {
      var _this = this;
      if (DEBUG) {
        console.log("close edit");
      }
      return this.$el.parent().fadeOut(function() {
...
(function() {
  ...
  App.Views.Application = (function(_super) {
    ...
    Application.prototype.addContact = function(event) {
      var addContactView, model;
      event.preventDefault();
      model = new App.Models.ContactModel;
      addContactView = new App.Views.AddContactView({
        model: model
      });
      return $('[data-role="edit-contact"]').html(addContactView.render().el).hide().fadeIn();
    };
...
(function() {
  ...
  App.Views.ContactView = (function(_super) {
    __extends(ContactView, _super);

    function ContactView() {
      this.editModel = __bind(this.editModel, this);
    ...
    ContactView.prototype.template = App.template('contactRow');

    ContactView.prototype.initialize = function() {
      if (DEBUG) {
        console.log("init ContactView");
      }
    ...
    ContactView.prototype.editModel = function(event) {
      var editContactView;
      event.preventDefault();
      if (DEBUG) {
        console.log("edit");
      ...
      return $('[data-role="edit-contact"]').html(editContactView.render().el).hide().fadeIn();
    };

    ContactView.prototype.removeModel = function(event) {
      event.preventDefault();
      if (DEBUG) {
        console.log("remove");
      }
    ...
    ContactView.prototype.unrender = function() {
      if (DEBUG) {
  ...
  App.Views.ContactsCollectionView = (function(_super) {
    ...
    function ContactsCollectionView() {
      ...
      _ref1 = ContactsCollectionView.__super__.constructor.apply(this, arguments);
      return _ref1;
    }

    ContactsCollectionView.prototype.tagName = "tbody";
    ...
    ContactsCollectionView.prototype.initialize = function() {
      ...
      return this.collection.on('change', function() {
        if (DEBUG) {
          return console.log("collection changed");
        }
      });
    };

    ContactsCollectionView.prototype.events = {
      'click .show-collection': 'showCollection'
    };

    ContactsCollectionView.prototype.render = function() {
      this.collection.each(this.addOne);
      return this;
    };

    ContactsCollectionView.prototype.addOne = function(contact) {
      var contactView;
      ...
      if (DEBUG) {
        return console.log("ContactsCollection", this.collection);
      }
    };

    ContactsCollectionView.prototype.addNew = function(contact) {
      this.collection.add(contact);
      if (DEBUG) {
        return console.log("updated collection", this.collection);
      }
    };

    ContactsCollectionView.prototype.showCollection = function(event) {
      event.preventDefault();
      if (DEBUG) {
...
//@ sourceMappingURL=editContact.map
(function() {
  'use strict';
  var _ref,
    __hasProp = {}.hasOwnProperty,
  ...
  App.Views.EditContactView = (function(_super) {
    __extends(EditContactView, _super);

    function EditContactView() {
      _ref = EditContactView.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    EditContactView.prototype.template = App.template('editContact');

    EditContactView.prototype.initialize = function() {
      if (DEBUG) {
        return console.log("init EditContactView", this.model);
      }
    };
    ...
    EditContactView.prototype.saveContact = function(event) {
      var form;
      event.preventDefault();
      form = $(event.target);
      this.model.set({
      ...
      if (DEBUG) {
        console.log('EditContactView save', this.model);
      }
      return this.unrender();
    };

    EditContactView.prototype.closeEdit = function(event) {
      event.preventDefault();
      return this.unrender();
    };

    EditContactView.prototype.unrender = function() {
      var _this = this;
      if (DEBUG) {
        console.log("close edit");
      }
...
(function() {
  ...
  App.Collections.ContactsCollection = (function(_super) {
    ...
    ContactsCollection.prototype.model = App.Models.ContactModel;

    ContactsCollection.prototype.initialize = function() {
      if (DEBUG) {
        return console.log("init ContactsCollection");
      }
    };
...
(function() {
  ...
  App.Router = (function(_super) {
    ...
    Router.prototype.index = function() {
      if (DEBUG) {
        return console.log("hello from index router");
      }
    };
