  ...
  grunt.initConfig
      ...
      dist:
        ...
        files: 
          "<%= yeoman.dist %>/scripts/main.js": [
            '<%= yeoman.app %>/scripts/vendor/underscore.js'
            '<%= yeoman.app %>/scripts/vendor/backbone.js'
            '.tmp/scripts/main.js'
    ...
    copy:
      dist:
        ...
        ,
          "<%= yeoman.dist %>/styles/bootstrap.min.css": "<%= yeoman.app %>/bower_components/bootstrap/dist/css/bootstrap.min.css"
        ]
